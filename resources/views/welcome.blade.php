...
@section('lang')
    <li class="scroll-to-section nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" style="margin-bottom: 5%;padding-left: 0%"
...
@section('content')
    ...
    <section class="section" id="services">
        <div class="container">
            ...
            <a href="https://drive.google.com/file/d/1tRm_1JE2KopNrporNQLszkXkZEQp1iRD/view">Here</a>
            <div class="row">
