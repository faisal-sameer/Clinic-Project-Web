                ...
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        ...
                        <a href="/reservation" class="main-button-slider" style="display: flex;  
                                                        ...
                                                        align-items: center;  "> {{ __('app.reservationHome') }} </a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                        <img src="images/طب الأسنان.png" class="rounded img-fluid d-block mx-auto"
                ...
                <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="text">
                                <h6>
                                    {{ __('app.OffersTopic, :NameAR', ['ar' => 'الاول', 'en' => 'firest']) }}
                        ...
                        <li>
                            ...
                            <div class="text">
                                <h6>
                                    {{ __('app.OffersTopic, :Name', ['name' => 'الثاني']) }}
                        ...
                        <li>
                            ...
                            <div class="text">
                                <h6>
                                    {{ __('app.OffersTopic, :Name', ['name' => 'الثالث']) }}
                                ...
                                <div class="col-lg-12">
                                    <fieldset>
                                        <button type="submit" onClick="window.location.reload();" id="form-submit"
                                            class="main-button">Send It</button>
                                    </fieldset>
                                </div>
                            </div>
                        </form>
