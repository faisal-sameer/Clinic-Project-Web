                        ...
                        @else
                            @foreach ($all['reservations'] as $reservation)
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" id="texttab" style="text-align: center">{{ $reservation->Date }} Day
                                    </td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">تعديل على موعد</h5>
                                                ...
                                                <form method="POST" action="{{ route('ChangeApp') }}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input id="idnational" type="text" name="Name" class="form-control"
                                                            placeholder="الاسم" value="{{ $reservation->Name }}">
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input id="idnational" type="text" name="Phone" class="form-control"
                                                            placeholder="رقم الجوال" value="{{ $reservation->Phone }}"
                                                            required>
